...
avengers = media.Movie('The Avengers',
                        "Earth's mightiest heroes must come together and learn to fight as a team to save humanity.",
                        "143 minutes",
...
movies = [toy_story, avatar, school_of_rock, ratatouille,
	midnight_in_paris, the_hunger_games, avengers, divergent, interstellar]

# pass the array to the open_movies_page() method to render them on the website page.
